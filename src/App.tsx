...
function App() {
  return (
    <main className="pokemon_card">
      <header className="card_header">
        <h3 className='card_name'>Bulbasaur</h3>
        <h3 className='card_number'>#001</h3>
      </header>
      ...
      <section className="pokemon_stats_container">
        ...
        <article className={"pokemon_types"}>
          ...
          <div className={"pokemon_type_poison"}>
            <svg
              width="17"
              height="17"
              viewBox="0 0 40 40"
        ...
        <article className={"pokemon_measures"}>
        ...
        <article>
          <ul className={"pokemon_stats_list"}>
            <li className={"pokemon_stats"}>
              HP<span className={"pokemon_stat_number"}>045</span>
              <progress className={"pokemon_progress_bar"} value={0.6} />
            </li>
            <li className={"pokemon_stats"}>
              ATK<span className={"pokemon_stat_number"}>045</span>
              <progress className={"pokemon_progress_bar"} value={0.3} />
            </li>
            <li className={"pokemon_stats"}>
              DEF<span className={"pokemon_stat_number"}>045</span>
              <progress className={"pokemon_progress_bar"} value={0.3} />
            </li>
            <li className={"pokemon_stats"}>
              SAT<span className={"pokemon_stat_number"}>045</span>
              <progress className={"pokemon_progress_bar"} value={0.9} />
            </li>
            <li className={"pokemon_stats"}>
              SDF<span className={"pokemon_stat_number"}>045</span>
              <progress className={"pokemon_progress_bar"} value={0.5} />
            </li>
            <li className={"pokemon_stats"}>
              SPD<span className={"pokemon_stat_number"}>045</span>
              <progress className={"pokemon_progress_bar"} value={0.5} />
            </li>
          </ul>
        </article>
